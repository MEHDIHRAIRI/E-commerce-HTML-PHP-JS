<?PHP
include "C:/wamp64/www/exemple/entities/cartes.php";
include "C:/wamp64/www/exemple/config.php";
include "C:/wamp64/www/exemple/core/cartesc.php";
$cartes=new CartesC();
$listecartes=$cartes->afficherTouTcartes();
?>
<!doctype html>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="liste commande" href="listecommande.php"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">liste commande</span></a></li>
                                <li><a title="liste cartes" href="listecartes.php"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">liste cartes</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="listecommande.php">Liste commande</a></li>
                                                <li><a href="listecarte.php">Liste carte</a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                         <div class="breadcome-heading">
                                            <form role="search" class="">
                                                <input id="myInput"  type="text" placeholder="Search..."  onkeyup="myFunction()" class="form-control">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">ID Cartes</th>
                                                <th data-field="name" data-editable="true">Nom Titulaire</th>
                                                <th data-field="company" data-editable="true">Num Carte</th>
                                                <th data-field="price" data-editable="true">Year</th>
												<th data-field="date" data-editable="true">Month</th>
												<th data-field="task" data-editable="true">Code</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                             <?php
                                        ...
                                        <tr>
                                                <td></td>
                                                <td><?php echo $id_cartes ?></td>
                                                <td><?php echo $row['nom_titulaire'] ?></td>
